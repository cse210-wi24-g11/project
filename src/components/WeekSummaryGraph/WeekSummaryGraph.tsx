import {getDateAbbr, getMoodDesc, MaxMoodValue, SummaryDayMoodRecord} from "@/components/SummaryHelper.ts";
...
const WeekSummaryGraph = (props: WeekSummaryProps) => {
  const {records} = props;
  ...
  return (
    <div className="mood-week-summary-graph">
...
export default WeekSummaryGraph;